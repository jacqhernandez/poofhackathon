...
Area.create(name: "Makati", province: "Metro Manila", is_city: true)
Area.create(name: "Muntinlupa", province: "Metro Manila", is_city: true)
...
EvacuationCenter.create(name:"Villamor Air Base Golf Course", contact_person: "Toni Garcia", contact_number: "09171234567")
EvacuationCenter.create(name:"Intramuros Golf Course", contact_person: "Kevin Cua", contact_number: "09171234567")
...
HealthCenter.create(name:"Red Cross Marikina", contact_person: "Toni Garcia", contact_number: "09171234567")
HealthCenter.create(name:"Ultra Pasig", contact_person: "Kevin Cua", contact_number: "09171234567")
